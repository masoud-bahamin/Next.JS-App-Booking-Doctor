        ...
        <div className='font-Work_Sans'>
            ...
            <div className='container px-4 md:px-0 py-6 lg:py-12'>
                <div className='flex justify-between items-center mb-8'>
                    <p className='text-base lg:text-xl'>2245 Doctors found</p>
                ...
                <div className='flex flex-col gap-5'>
                    <div className='max-w-4xl mx-auto  border p-6 rounded-md'>
                        <div className='flex gap-5 mb-4'>
                            ...
                            <div className=' bg-white rounded-b-md'>
                                <div className='flex justify-between mb-3'>
                                    <h3><Link href={`/doctor/_id`}>Dr. Ruby Perrin</Link></h3>
                        ...
                        <div className='flex justify-between'>
                            <button className='btn-b mb-3 text-xs'>View Profile</button>
                            <a className='btn inline-block text-center mb-3 text-xs' href="#appointment">BOOK APPOINTMENT</a>
                        </div>
                    </div>
                    <div className='max-w-4xl mx-auto  border p-6 rounded-md'>
                        <div className='flex gap-5 mb-4'>
