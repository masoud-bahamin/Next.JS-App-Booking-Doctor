...
import img4 from "@/public/img/doctor-02.jpg"

function About() {
    return (
        <div className='font-Work_Sans'>
            <Breadcrumb title='ABOUT' route='about' />
            <div className='container px-4 md:px-0 py-6 lg:py-12'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-10'>
                    <div className='flex gap-4 '>
                        <div>
                            <Image className='h-fit mb-4' src={img1.src} width={300} height={400} alt='' quality={100} />
                            <Image className='h-fit' src={img2.src} width={300} height={200} alt='' quality={100} />
                        </div>
                        <div>
                            <Image className='h-fit mb-4' src={img4.src} width={300} height={400} alt='' quality={100} />
                            <Image className='h-fit' src={img3.src} width={300} height={400} alt='' quality={100} />
                        </div>
                    </div>
                    <div>
                        <p className='my-8 text-prim'>About Our Company</p>
                        <h2 className='text-2xl lg:text-4xl font-Barlow font-medium lg:font-semibold mb-6'>We Are Always Ensure Best Medical Treatment For Your Health</h2>
                        ...
                        <p className='mb-10 text-paragraf text-sm lg:text-base'>
                            ...
                            doloremque eaque ipsa quae architecto beatae vitae dicta sunt explicabo.
                        </p>
                        <div className='flex gap-4 items-center'>
                            <div className='rounded-full bg-prim p-3'>
                                <svg width="24px" height="24px" stroke-width="1.1" viewBox="0 0 24 24"
                            ...
                            <div>
                                <p className='mb-2 text-paragraf text-sm lg:text-base'>Need Emergency?</p>
