  ...
  return (
    <div className="font-Work_Sans">
      ...
      <div className="container px-4 md:px-0 pb-20 flex flex-wrap md:flex-nowrap items-center border-b">
        ...
        <div className="py-10 md:p-20 shadow-md md:-ml-20 z-10 bg-white h-fit">
          <h2 className="text-4xl mb-6 font-bold font-Barlow">
          ...
          <p className="mb-5">
            ...
            attractive design will only get you far. With people increasingly
            using their tablets and smartphones and shop online,...
          </p>
        ...
        <div className="md:w-2/3  pt-20">
          <div className="grid md:grid-cols-2 gap-10">
            <div className=" hover:-translate-y-2 duration-500 cursor-pointer">
              <div className="mb-6">
                <img
                  src="https://htmlguru.net/genial/assets/img/posts/01.jpg"
                  alt=""
                />
              </div>
              <h2 className="text-2xl mb-6 font-semibold font-Barlow">
                Nature Photography Best Focus
              </h2>
              <p className="text-sm mb-5 font-light">
                18-04-21 / Design, Travel, photography, Nature
            ...
            <div className=" hover:-translate-y-2 duration-500 cursor-pointer">
              <div className="mb-6">
                <img
                  src="https://htmlguru.net/genial/assets/img/posts/04.jpg"
                  alt=""
                />
              </div>
              <h2 className="text-2xl mb-6 font-semibold font-Barlow">
          ...
          <div className="my-20 text-center">
            <button className="bg-black text-white px-12 py-4 font-semibold font-Barlow hover:text-black hover:bg-gray-200">
              Load More
            </button>
          </div>
        </div>
        <div className="md:w-1/3 md:border-l md:pl-10 pt-10 md:pt-20">
          <div className="text-center mb-8">
            <img
              className="mb-6 rounded-full mx-auto"
              src="https://htmlguru.net/genial/assets/img/sidebar/author.jpg"
              alt=""
            />
